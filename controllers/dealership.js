...
const getItem = async (req, res) => {
	let transaction;
	try {
		const { dealershipIdOrName } = req.params;

		// Se obtiene una instancia de la transacción:
		transaction = await sequelize.transaction();

		// Se ejecuta la consulta dentro de la transacción:
		const data = await Dealership.findOne({
...
/**
 * Obtiene una lista de elementos de la tabla dealership utilizando paginación y una transacción de base de datos.
...
const createItem = async (req, res) => {
	...
	try {
		...
		// Se ejecuta la consulta dentro de la transacción:
		const data = await Dealership.create(body, { transaction });
...
/**
 * Obtiene un elemento de la tabla dealership según su ID o código de producto, utilizando una transacción de base de datos.
 * @param {Object} req - Objeto de solicitud HTTP.
 * @param {Object} res - Objeto de respuesta HTTP.
