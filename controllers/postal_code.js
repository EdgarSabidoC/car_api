...
/**
 * Obtiene una lista de elementos de la tabla postal_code utilizando paginación y una transacción de base de datos.
...
const createItem = async (req, res) => {
	...
	try {
		...
		// Se ejecuta la consulta dentro de la transacción:
		const data = await PostalCode.create(body, { transaction });
...
/**
 * Obtiene un elemento de la tabla postal_code según su ID o código de producto, utilizando una transacción de base de datos.
 * @param {Object} req - Objeto de solicitud HTTP.
 * @param {Object} res - Objeto de respuesta HTTP.
